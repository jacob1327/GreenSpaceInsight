...
app.layout = html.Div([
    html.Div([
        html.H1("GreenSpace Insight", style={'text-align': 'center'}, className="header-title"),
        html.P(
            children="Analyzing the effect of green spaces on public health Computer Science Internal Assessment",
